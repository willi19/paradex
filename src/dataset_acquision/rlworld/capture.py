...
def initialize_device(args):
    ...
    controller["camera"] = RemoteCameraController("video", serial_list=None, sync=True, debug=True)
...
run_script(f"python src/dataset_acquision/rlworld/video_client.py", pc_list)
...
save_path = os.path.join("capture", "rlworld", args.obj_name)
