...
# /openarm/joint_states(16) order:
# [head_pitch, head_yaw, r1, r4, l6, l5, l2, l7, l4, r5, l1, r6, r3, l3, r7, r2]
# Indices that map 16-dim joint_states -> SOURCE_QPOS_ORDER (14-dim).
...
def project_robot_and_object(
    ...
    if project_robot:
        ...
        if overlay_option == "action":
            ...
            left_hand_action, left_hand_time = load_series(hand_dir, ("left_joint_states.npy",))
            right_hand_action, right_hand_time = load_series(hand_dir, ("right_joint_states.npy",))
