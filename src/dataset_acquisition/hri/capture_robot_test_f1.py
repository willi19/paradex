...
last_idx = int(find_latest_index(os.path.join(shared_dir, "capture", "hri_inspire_f1_right", args.name)))
...
while True:
    ...
    cs.start(os.path.join("capture", "hri_inspire_f1_right", args.name, str(last_idx)))
