...
# Fuze trimesh
fuze_trimesh = trimesh.load('./rsc/object/pringles/pringles.obj')
fuze_mesh = Mesh.from_trimesh(fuze_trimesh)

# Drill trimesh
drill_trimesh = trimesh.load('./rsc/object/pringles/pringles.obj')
...
# Wood trimesh
wood_trimesh = trimesh.load('./rsc/object/pringles/pringles.obj')
