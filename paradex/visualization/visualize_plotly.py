...
from utils.io import get_obj_info
...
if __name__ == "__main__":
    ...
    main(Path(args.scene_path), object_nm, args.obj_status_path, args.downsample_factor, draw_tg=['mesh', 'camera'])
