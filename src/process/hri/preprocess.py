...
if __name__ == '__main__':
    ...
    if args.obj_name == None:
        name_list = os.listdir(os.path.join(shared_dir, 'capture_', "hri_teleop"))
        name_list.sort()
    ...
    for name in name_list:
        grasp_list = os.listdir(os.path.join(shared_dir, "capture_", "hri_teleop", name))
    ...
    for name, grasp_type in process_list:
        root_dir = os.path.join(shared_dir, "capture_", "hri_teleop", name, grasp_type)
