...
GPU_EFFICIENT_SAM_CHECKPOINT = os.path.join(shared_dir,"model","efficient_sam_s_gpu.jit")
CPU_EFFICIENT_SAM_CHECKPOINT = os.path.join(shared_dir,"model","efficient_sam_s_cpu.jit")
