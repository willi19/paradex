...
franka_ip_address="192.168.1.221"

class XArmController:
    def __init__(self, save_path=None):

        self.franka_ip_address = franka_ip_address
        self.franka_home_pose = None#[v for v in xarm_home_pose]#xarm_home_pose.copy()
    ...
    def set_homepose(self, home_pose):
        self.franka_home_pose = home_pose.copy()
    ...
    def home_robot(self):
        self.arm_target_action_array[:] = self.franka_home_pose.copy()
