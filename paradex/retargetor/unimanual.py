...
from paradex.retargetor.hand_regargetor import inspire, allegro, inspire_f1, kistar
...
class Retargetor(): # Input is only from Xsens
    def __init__(self, arm_name=None, hand_name=None, hand_side="Right"):
        ...
        if hand_name not in [None, "inspire", "allegro", "inspire_f1", "kistar"]:
        ...
        elif self.hand_name == "kistar":
            self.hand_retargetor = kistar
        else:
            self.hand_retargetor = None
