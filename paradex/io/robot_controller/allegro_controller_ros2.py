...
class AllegroController(Node):
    def __init__(self, addr=None, **_):
        ...
        # Match inspire_f1_state_receiver: subscriptions are serviced by a dedicated
        # executor thread so joint states keep updating while the control loop runs.
    ...
    def control_loop(self):
        ...
        while (
            rclpy.ok()
            and not self.connection_event.is_set()
