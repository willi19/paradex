...
listen_keyboard({"c":save_event, "s":stop_event})
...
print("ready to capture videos. Press 'c' to capture, 's' to stop.")
...
try:
    ...
    while not stop_event.is_set():
        ...
        hand_action = np.array([1000, 1000, 1000, 1000, 1000, 1000])
        ...
        raw_dir = os.path.join(shared_dir, args.save_path, date_str, "raw")
