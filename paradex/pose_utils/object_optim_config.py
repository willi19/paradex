...
from paradex.pose_utils.vis_utils import make_grid_image_np, putText, crop_and_resize_by_mask
...
def parse_args():
    ...
    parser.add_argument('--obj_name', type=str, required=True)# for parallel processing 
    ...
    parser.add_argument('--fibonacci_numb', type=int, default=600)
    parser.add_argument('--initial_cam_id', type=str, default='22641005')
    ...
    parser.add_argument('--mask_logic', type=str, default='yolo', choices=['precomputed','yolo'])
