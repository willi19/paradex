...
def rigid_transform_3D_ransac(pt1, pt2, sample_ratio=0.2, with_scale=False, num_iter=500, threshold=0.001):
    best_inlier_count = 0
    best_R = None
    best_t = None
    best_T = None
...
def triangulate_ransac_batched(corners:dict, projections:list, sample_ratio:float, num_iter = 2000, threshold=2):
    """
