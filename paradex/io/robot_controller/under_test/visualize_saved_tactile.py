...
# TACTILE_PATH = BASE_PATH + "/raw/hand/tactile.npy"
# HAND_POSITION_PATH = BASE_PATH + "/raw/hand"
# ARM_POSITION_PATH = BASE_PATH + "/raw/arm/position.npy"
# VIDEO_PATH = BASE_PATH + "/videos/22645029.avi"
...
# ======================================================
def main():
    # Load data and align tactile/action/arm sequences to the video timeline.
    parser = argparse.ArgumentParser()
    parser.add_argument("--object", type=str, required=True, help="Object name for data path.")
    parser.add_argument("--ep", type=int, required=True, help="Episode number.")

    args = parser.parse_args()
    
    base_path = os.path.join(BASE_PATH, args.object, str(args.ep))
    ...
    def render_frame(t):
        # Render robot links and tactile arrows for frame t.
        arm_q = arm_i[t]
        hand6 = hand_i[t]
        ...
        tactile = unpack_tactile_frame(tactile_i[t], tactile_index)
