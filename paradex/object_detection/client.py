...
from paradex.object_detection.default_config import default_template_combined, name2prompt, prompt2name, template2camids
...
for obj_name in args.obj_names:
    tmp_template = Template(str(default_template_combined[obj_name]), obj_name=obj_name) # template has mask and rgb image. 
