...
class Template:
    ...
    '''
    def __init__(self, root_dir:str, obj_name=None):
        ...
        if obj_initial_status is not None:
            ...
            template_path = self.scene.scene_path/'initial_template.pkl'
    ...
    def render_template(self, obj_dict, obj_optim_output):
        ...
        cv2.imwrite('./check_template.jpeg', cv2.cvtColor(make_grid_image_np(np.stack(imgs), 4, 6),cv2.COLOR_BGR2RGB))
