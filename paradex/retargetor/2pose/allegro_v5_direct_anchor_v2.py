"""Frozen Allegro direct-anchor v2 snapshot for two-pose comparisons.

Source: the default retargeter immediately before commit ``21fe2f9a``.
Its adjacent anchor JSON is intentionally private to this module.
"""
...
_ALLEGRO_V5_DIRECT_ANCHOR_CONFIG = (
    Path(__file__).with_name("allegro_v5_direct_anchor_v2_anchors.json")
)
