import json
from paradex.model.HandModel import HandModel
...
def get_handmodel(robot, batch_size, device, hand_scale=1.):
    ...
    # urdf_path = f"{rsc_path}/{robot}/{robot}.urdf" # urdf_assets_meta['urdf_path'][robot]
    # meshes_path = f"{rsc_path}/{robot}/meshes"#urdf_assets_meta['meshes_path'][robot]
